...
if (file_exists(__DIR__ . '/../config.php')) {
    ...
    $siteTitle = 'Dr. Chhabi Adhikari | D School System | NLP Training in Nepal';
    ...
    <header>
        <div class="container">
            <nav role="navigation" aria-label="Main navigation">
                <div class="logo">
                    <a href="/index.php">D-SCHOOL<span>SYSTEM</span></a>
                </div>
                <ul class="nav-links" role="menubar">
                    <li class="nav-item" role="none"><a href="index.php" role="menuitem">Home</a></li>
                    <li class="nav-item" role="none"><a href="about.php" role="menuitem">About</a></li>
                    <li class="nav-item" role="none"><a href="blog.php" role="menuitem">News</a></li>
                    <li class="nav-item" role="none"><a href="videos.php" role="menuitem">Videos</a></li>
                    <li class="nav-item" role="none"><a href="gallery.php" role="menuitem">Gallery</a></li>
                    <li class="nav-item" role="none"><a href="courses.php" role="menuitem">Services</a></li>
                    <li class="nav-item" role="none"><a href="contact.php" role="menuitem">Contact Us</a></li>
                </ul>
